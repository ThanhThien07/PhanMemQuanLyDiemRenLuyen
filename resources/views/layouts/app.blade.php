    ...
    <aside class="fixed top-[70px] bottom-0 left-0 w-[260px] z-[1020] bg-[#161514] border-r border-[#262422] pt-3 transition-all duration-300 overflow-y-auto ms-sidebar">
      @auth
        <div class="flex flex-col gap-4">
          ...
          <div>
            <div class="px-5 pt-3 pb-2 text-uppercase text-amber-500 font-bold tracking-widest flex items-center gap-2 cursor-pointer select-none hover:text-amber-400 transition-colors duration-200" 
                 data-bs-toggle="collapse" data-bs-target="#menuQuanLy" aria-expanded="true" aria-controls="menuQuanLy">
              <i class="bi bi-sliders text-amber-500" style="font-size: 12px;"></i>
              <span>KHU VỰC QUẢN LÝ</span>
              <i class="bi bi-chevron-down ms-auto text-xs transition-transform duration-200 collapse-chevron"></i>
            </div>
          ...
          <div>
            <div class="px-5 pt-2 pb-2 text-uppercase text-amber-500 font-bold tracking-widest flex items-center gap-2 cursor-pointer select-none hover:text-amber-400 transition-colors duration-200" 
                 data-bs-toggle="collapse" data-bs-target="#menuHeThong" aria-expanded="true" aria-controls="menuHeThong">
              <i class="bi bi-folder-fill text-amber-500" style="font-size: 12px;"></i>
              <span>DANH MỤC HỆ THỐNG</span>
              <i class="bi bi-chevron-down ms-auto text-xs transition-transform duration-200 collapse-chevron"></i>
            </div>
            <div class="collapse show" id="menuHeThong">
              <ul class="flex flex-col mb-0 p-0 list-none gap-1">
                <li>
          ...
          <div>
            <div class="px-5 pt-2 pb-2 text-uppercase text-amber-500 font-bold tracking-widest flex items-center gap-2 cursor-pointer select-none hover:text-amber-400 transition-colors duration-200" 
                 data-bs-toggle="collapse" data-bs-target="#menuPhucVu" aria-expanded="true" aria-controls="menuPhucVu">
              <i class="bi bi-people-fill text-amber-500" style="font-size: 12px;"></i>
              <span>KÍP PHỤC VỤ</span>
              <i class="bi bi-chevron-down ms-auto text-xs transition-transform duration-200 collapse-chevron"></i>
            </div>
            <div class="collapse show" id="menuPhucVu">
